...
const books = [
  {
    ...
    "synapsis": "In a land where dragons have all but disappeared, a young boy finds a dragon egg and discovers that he is destined to be its rider and defend his homeland against the evil king who now reigns."
  },
  {
    "id": 2,
    ...
    "synapsis": "The story of the five Bennet sisters living in early 19th century England. Their mother is scheming to make prestigious marriages for them. Focuses on Elizabeth Bennet, who mistakenly finds the rich Mr. Darcy an oaf, even as he sets all the other fair maidens' hearts aflutter."
  },
  {
    "id": 3,
    ...
    "synapsis": "Emily Elizabeth loves her huge dog Clifford even though he is far from perfect."
  },
  {
    "id": 4,
    "title":"The Hobbit",
  ...
  },
  {
    ...
    "synapsis": "Harry Potter has never even heard of Hogwarts when the letters start dropping on the doormat at number four, Privet Drive. Addressed in green ink on yellowish parchment with a purple seal, they are swiftly confiscated by his grisly aunt and uncle. Then, on Harry's eleventh birthday, a great beetle-eyed giant of a man called Rubeus Hagrid bursts in with some astonishing news: Harry Potter is a wizard, and he has a place at Hogwarts School of Witchcraft and Wizardry. An incredible adventure is about to begin!"
  },
  {
    "id": 6,
